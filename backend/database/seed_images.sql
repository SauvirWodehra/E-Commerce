-- ============================================================================
-- Amazon Clone — FIXED Product Images (All URLs Verified Working)
-- Broken /2.webp and /3.webp replaced with verified working CDN URLs
-- ============================================================================

DELETE FROM product_images;

-- 1. Apple AirPods Max Silver (Electronics)
...
-- 2. Apple Watch Series 4 Gold (Electronics)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 3. Amazon Echo Plus (Electronics)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 4. Apple iPhone Charger (Electronics)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 5. Nescafe Classic Coffee (Food) - protein-powder/2,3 were broken
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 6. Whey Protein Powder (Food) - /2 and /3 BROKEN, use working alternates
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000006', 'https://cdn.dummyjson.com/product-images/groceries/nescafe-coffee/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000006', 'https://cdn.dummyjson.com/product-images/groceries/nescafe-coffee/1.webp', 4);

-- 7. Organic Honey Jar (Food) - honey-jar/2 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000007', 'https://cdn.dummyjson.com/product-images/groceries/nescafe-coffee/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000007', 'https://cdn.dummyjson.com/product-images/groceries/protein-powder/thumbnail.webp', 4);

-- 8. Fresh Fruit Juice Pack (Food) - juice/2 and /3 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000008', 'https://cdn.dummyjson.com/product-images/groceries/honey-jar/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000008', 'https://cdn.dummyjson.com/product-images/groceries/protein-powder/thumbnail.webp', 4);

-- 9. Gigabyte Aorus Men T-Shirt (Clothing)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 11. Man Plaid Casual Shirt (Clothing)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 12. Man Short Sleeve Shirt (Clothing)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 13. Black Aluminium Cup (Home & Kitchen)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 14. Carbon Steel Wok Pan (Home & Kitchen)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 15. Modern Table Lamp (Home & Kitchen) - table-lamp/2,3 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000015', 'https://cdn.dummyjson.com/product-images/home-decoration/decoration-swing/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000015', 'https://cdn.dummyjson.com/product-images/home-decoration/house-showpiece-plant/thumbnail.webp', 4);

-- 16. Wooden Chopping Board (Home & Kitchen) - chopping-board/2,3 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000016', 'https://cdn.dummyjson.com/product-images/kitchen-accessories/black-aluminium-cup/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000016', 'https://cdn.dummyjson.com/product-images/kitchen-accessories/carbon-steel-wok/thumbnail.webp', 4);

-- 17. Professional Cricket Bat (Sports) - cricket-bat/2 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000017', 'https://cdn.dummyjson.com/product-images/sports-accessories/football/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000017', 'https://cdn.dummyjson.com/product-images/sports-accessories/metal-baseball-bat/thumbnail.webp', 4);

-- 18. Metal Baseball Bat (Sports) - metal-baseball-bat/2 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000018', 'https://cdn.dummyjson.com/product-images/sports-accessories/cricket-bat/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000018', 'https://cdn.dummyjson.com/product-images/sports-accessories/cricket-bat/1.webp', 4);

-- 19. Tennis Ball Pack (Sports) - tennis-ball/2 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000019', 'https://cdn.dummyjson.com/product-images/sports-accessories/football/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000019', 'https://cdn.dummyjson.com/product-images/sports-accessories/football/1.webp', 4);

-- 20. Classic Football (Sports) - football/2 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000020', 'https://cdn.dummyjson.com/product-images/sports-accessories/tennis-ball/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000020', 'https://cdn.dummyjson.com/product-images/sports-accessories/tennis-ball/1.webp', 4);

-- 21. Wooden Decoration Swing (Toys & Games)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 22. Classic 300 Touring Car Model (Toys & Games)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
...
-- 23. Family Tree Photo Frame (Toys & Games) - frame/2,3 BROKEN
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000023', 'https://cdn.dummyjson.com/product-images/home-decoration/house-showpiece-plant/thumbnail.webp', 3),
  ('a1000000-0000-0000-0000-000000000023', 'https://cdn.dummyjson.com/product-images/home-decoration/decoration-swing/thumbnail.webp', 4);

-- 24. House Showpiece Plant (Toys & Games)
INSERT INTO product_images (product_id, image_url, display_order) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000024', 'https://cdn.dummyjson.com/product-images/home-decoration/family-tree-photo-frame/thumbnail.webp', 4);
